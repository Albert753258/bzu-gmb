...
tput setaf 2; echo "Установка Kdenlive  нелинейного видеоредактора с открытым исходным кодом [https://kdenlive.org/]. Установка Kdenlive осуществлыется через оригинальный репозиторий Kdenlive. Версия скрипта 1.0, автор: Яцына М.А."
tput sgr0

#запуск основных команд модуля
echo "${pass_user}" | sudo -S emerge --update kdenlive || let "error += 1"
#формируем информацию о том что в итоге установили и показываем в терминал
app_name="kdenlive"
if [ 'eix-installed -a | grep kde-apps/kdenlive' != "" ];then
