...
sudo -S chmod +x "/usr/share/xboxdrv/xboxdrv.sh" || let "error += 1"
sudo -S chmod +x /usr/share/xboxdrv/xboxdrv.desktop || let "error += 1"
sudo -S cp -ax /usr/share/xboxdrv/xboxdrv.desktop /usr/share/applications/ || let "error += 1"
cd
...
tput sgr0
bash -c "${script_dir_install}xboxdrv/xboxdrv.sh" & sleep 5;sudo -S killall xboxdrv-qt-5.6-rc
