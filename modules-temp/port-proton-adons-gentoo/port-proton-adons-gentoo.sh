...
tput setaf 2; echo "Установка дополнительныз пакетов и утилит для портов проекта portwine https://portwine-linux.ru/portwine-faq/]. Версия скрипта 1.1, автор: Яцына М.А."
tput sgr0

#запуск основных команд модуля

sudo -S emerge --update sys-apps/bubblewrap net-misc/curl games-util/gamemode media-gfx/icoutils app-arch/tar dev-util/vulkan-tools media-libs/vulkan-loader net-misc/wget gnome-extra/zenity app-arch/zstd games-util/steam-launcher app-arch/cabextract || let "error += 1"
